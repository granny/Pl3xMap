...
public class BlockInfoRenderer extends Renderer {
    ...
    public void scanData(RegionCoordinate region, ScanData.Data scanData) {
        ...
        Palette<Block> blockPalette = Pl3xMap.api().getPaletteRegistry().getBlockPalette();
        Palette<Biome> biomePalette = Pl3xMap.api().getPaletteRegistry().getBiomePalette(getWorld());
