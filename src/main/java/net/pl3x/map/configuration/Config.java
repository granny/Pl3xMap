...
public class Config extends AbstractConfig {
    @Key(get = "settings.debug-mode")
    @Comment(get = """
            Extra logger output.
            (can be spammy)""")
    public static boolean DEBUG_MODE = false;
    @Key(get = "settings.language-file")
    @Comment(get = "The language file to use in locale/ folder.")
    public static String LANGUAGE_FILE = "lang-en.yml";

    @Key(get = "settings.web-directory.path")
    @Comment(get = "The directory that houses the Pl3xMap website and world tiles.")
    public static String WEB_DIR = "web";
    @Key(get = "settings.web-directory.read-only")
    @Comment(get = """
    ...
    @Key(get = "settings.web-directory.tile-format")
    @Comment(get = """
    ...
    @Key(get = "settings.internal-webserver.enabled")
    @Comment(get = """
    ...
    @Key(get = "settings.internal-webserver.bind")
    @Comment(get = """
    ...
    @Key(get = "settings.internal-webserver.port")
    @Comment(get = "The port the built-in web server listens to.")
    public static int HTTPD_PORT = 8080;

    @Key(get = "settings.threading.render-threads")
    @Comment(get = """
